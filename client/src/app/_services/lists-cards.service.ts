...
export class ListsCardsService {
  ...
  getListsCardsByBoardId(id: number) {
    return this.http.get<ListCardsModel[]>(
      this.baseUrl + 'listCards/allBy/' + id,
    );
  }
  ...
  updateListCards(updateListCardsModel: ListCardsModel) {
    return this.http.put<ListCardsModel>(
      this.baseUrl + 'listCards',
      updateListCardsModel,
    );
  }

  createListCards(createListCardsModel: CreateListCardsModel) {
    return this.http.post<CreateListCardsModel>(
      this.baseUrl + 'listCards',
      createListCardsModel,
    );
  }
}
