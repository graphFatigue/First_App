...
const decorators = [
    applicationConfig({
      providers: [
        ...
        importProvidersFrom(HttpClientModule), importProvidersFrom(MatDialogModule), importProvidersFrom(MatButtonModule),
...
type DeleteCardModalWindowComponentStory = StoryObj<DeleteCardModalWindowComponent>;
